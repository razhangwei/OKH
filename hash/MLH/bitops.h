...
inline int match (UINT8 *P, UINT8 *Q, int codelb)
{
	switch(codelb)
  {
		...
		break;
		case 16:
			return __builtin_popcountll(((UINT64*)P)[0] ^ ((UINT64*)Q)[0]) + __builtin_popcountll(((UINT64*)P)[1] ^ ((UINT64*)Q)[1]);
		break;
		case 32:
			return __builtin_popcountll(((UINT64*)P)[0] ^ ((UINT64*)Q)[0]) + __builtin_popcountll(((UINT64*)P)[1] ^ ((UINT64*)Q)[1]) + __builtin_popcountll(((UINT64*)P)[2] ^ ((UINT64*)Q)[2]) + __builtin_popcountll(((UINT64*)P)[3] ^ ((UINT64*)Q)[3]);
		break;
		default:
			int output = 0;
